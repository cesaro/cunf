...
\hypersetup{
  ...
  pdftitle={The Cunf Tool User's Manual, v1.6},
...
\item
  ...
  between Petri net formats, unfolding formats, \etc
\end{enumerate}
...
From the following address, choose the bundle with precompiled binaries
...
\item[\cod{CONFIG\_SIZELEX}]  Selects the \emph{size-lexicographic} order
...
\item[\cod{CONFIG\_NODELIST\_STEP}]  Defines the number of items to be
